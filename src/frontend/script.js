...
function playTTS(text){
    ...
    utterance.voice = speechSynthesis.getVoices().find(v => useFemaleVoice ? v.name.includes("Female") : v.name.includes("Male")) || null;
...
function appendMessage(sender,text,isCode=false){
    ...
    if(isCode){
        const pre=document.createElement("pre"); pre.className="code-block language-javascript";
        const code=document.createElement("code"); code.className="language-javascript"; code.textContent=text;
